...
( function() {
	...
	registerBlockType( 'gb/basic-01', { // Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
		...
		edit: function( props ) {
			...
			return el(
				'p', // Tag type.
				{ className: 'example-block' }, // The class="wp-block-gb-basic-01" : The class name is generated using the block's name prefixed with wp-block-, replacing the / namespace separator with a single -.
