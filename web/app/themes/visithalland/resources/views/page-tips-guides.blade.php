	...
	<div class="container col-11 md-col-10 pb4">
		...
		<div class="content-grid__container pt4">
			...
			<div class="content-grid__content">
				...
				<header class="bg-blue rift-font text-sm bold px3 py2 mb3 rounded-pill inline-block text-light">Utvalda artiklar</header>

				<a href="" title="" class="mb3">
                    <article class="scrim overflow-hidden aspect-container aspect-1 md-aspect-16x9 relative rounded">
                        <picture>
			...
			<div class="content-grid__sidebar mxn3">
				<div class="col-12 px3">
					<!-- Insert Sidebar Content with class "content-grid__sidebar-child" -->
			...
			<div class="content-grid__bottom-content">
				<header class="bg-blue rift-font text-sm bold px3 py2 rounded-pill inline-block text-light">Article Grid</header>

				
				<div class="clearfix mxn3">
				

					<div class="col col-12 md-col-6 px3 mt3">
