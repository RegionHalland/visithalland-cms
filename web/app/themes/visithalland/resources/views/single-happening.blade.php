...
@section('content')
    ...
    <div id="infinite-container">
    	<article class="{{ App::getTermClassName() }} infinite-item" data-posttype="{{get_post_type()}}">
            ...
            <div class="clearfix container mt-4 mb-5">
                <div class="w-11/12  sm:w-9/12  md:w-11/12  mx-auto clearfix">
                    <div class="happening__content col w-full md:w-6/12  mt-2">
                        <p class="preamble">{{ get_field("excerpt") }}</p>
                    </div>
                    <aside class="col w-full md:w-6/12  mt-3">
                        <div class="happening-info topographic-pattern">
                            ...
                            <div class="happening-info__inner clearfix">
                                <section class="happening-info__section col w-full sm:w-4/12">
