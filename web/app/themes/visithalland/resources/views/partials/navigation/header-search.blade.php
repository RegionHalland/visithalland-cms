<div class="header-search mt-2 md:mt-0 md:h-16 flex items-center pl-3 lg:pl-8 xl:pl-3 md:order-2">
    <div class="header-search__form relative flex items-center">
    	<form method="get" action="/?s=">
	        ...
	        <input name="s" id="s" class="header-search__input focus border-none appearance-none px-4 py-3 hidden xl:block w-64 font-fira rounded-full italic text-sm text-white bg-blue-light h-10" type="search" placeholder="@php _e( 'Restauranger', 'visithalland' ) @endphp, @php _e( 'Utflykter', 'visithalland' ) @endphp">
