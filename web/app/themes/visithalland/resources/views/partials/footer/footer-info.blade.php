...
<div class="footer__social col col-12 sm-col-6 md-col-8 flex px3 mb3">
    <a href="mailto:info@visithalland.com" target="_blank" class="link-reset inline-block">
        <div class="social-icon bg-blue-xlight hover rounded-full flex items-center justify-center">
            <svg class="icon-sm">
