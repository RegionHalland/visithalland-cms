            ...
            <div class="w-full sm:w-6/12 lg:w-full px-2">
                @event_list_item(
                    [
                        ...
                        'start_date_month' => $dateobj = strftime("%b", strtotime($happening->meta_fields['start_date'])),
                        'end_date_day' => $dateobj = date("j", strtotime($happening->meta_fields['end_date'])),
                        'end_date_month' => $dateobj = strftime("%b", strtotime($happening->meta_fields['end_date'])),
                    ]
                )
                @endevent_list_item
            </div>
