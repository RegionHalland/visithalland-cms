    ...
    <ul class="w-full flex justify-between md:justify-start lg:justify-end">
        @foreach(App::getPrimaryNavigationItems() as $primary_navigation_item)
            ...
            <li class="sm:mr-4 md:ml-2 md:mr-0 lg:ml-6">
                <button id="dropdown-button" class="has-dropdown hover font-rift outline-none text-white inline-flex items-center white-space-nowrap text-base text-white font-bold" aria-haspopup="true" aria-expanded="false">
            ...
            @else
                <li class="sm:mr4 md:ml-2 md:mr-0 lg:ml-6">
                    <a href="{{$primary_navigation_item->url}}" class="outline-none hover font-rift text-white inline-flex items-center white-space-nowrap text-base text-white font-bold">
