...
@if(isset($tips) && is_array($tips))
    <section class="mt-5 mb-5 container w-11/12  md:w-10/12  lg:w-10/12  mx-auto {{ App::getTermClassName() }}">
        ...
        <div class="flex flex-wrap -mx-2">
            @foreach ($tips as $key => $tip)
                ...
                <div class="w-full sm:w-6/12 md:w-4/12 px-2">
                    <a href="{{ the_permalink($current_tip->ID) }}" title="{!! $current_tip->post_title !!}" class="mb-3 block">
