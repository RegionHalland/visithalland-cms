    ...
    <article class="scrim overflow-hidden aspect-container aspect-1 sm-aspect-16x9 relative rounded">
        <picture>
            <source media="(min-width: 40em)"
                data-srcset="{{ $happening->featured_image["sizes"]['vh_hero_wide'] . " 1x," . $happening->featured_image["sizes"]['vh_hero_wide@2x'] . " 2x" }}" />
            <source
            ...
            <img class="absolute left-0 top-0 w-fill lazyload"
                data-src="{{ $happening->featured_image["sizes"]['vh_hero_wide'] }}"
            />
        </picture>
