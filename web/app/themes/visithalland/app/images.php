...
// Remove default sizes when uploading a new image
...
add_action('image_size_names_choose', function ($sizes)
{
    // Remove default sizes from screen when choosing image size
    unset($sizes['thumbnail']);
    unset($sizes['medium']);
    unset($sizes['medium_large']);
    unset($sizes['large']);
